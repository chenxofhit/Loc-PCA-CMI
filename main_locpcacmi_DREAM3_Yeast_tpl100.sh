...
clusterfile="$curdir/$resdir/Dream100_Yeast_cluster.mat"

#output
zeropc_adjmatrix="$curdir/$resdir/Dream100_Yeast_adjmatrixg.mat"
...
#res 
zeropc_resfile="$curdir/$resdir/Dream100_Yeast.res"
