...
clusterfile="$curdir/$resdir/Dream10_Ecoli_cluster.mat"

#output
zeropc_adjmatrix="$curdir/$resdir/Dream10_Ecoli_adjmatrixg.mat"
...
#res 
zeropc_resfile="$curdir/$resdir/Dream10_Ecoli.res"
