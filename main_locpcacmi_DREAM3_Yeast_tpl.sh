...
clusterfile="$curdir/$resdir/Dream10_Yeast_cluster.mat"

#output
zeropc_adjmatrix="$curdir/$resdir/Dream10_Yeast_adjmatrixg.mat"
...
#res 
zeropc_resfile="$curdir/$resdir/Dream10_Yeast.res"
