...
clusterfile="$curdir/$resdir_locpcacmi/Dream50_Yeast_cluster.mat"

#output
loc_pcacmi_adjmatrix="$curdir/$resdir_locpcacmi/Dream50_Yeast_adjmatrixg.mat"
loc_pcapmi_adjmatrix="$curdir/$resdir_locpcapmi/Dream50_Yeast_adjmatrixg.mat"
...
#res 
loc_pcacmi_resfile="$curdir/$resdir_locpcacmi/Dream50_Yeast.res"
loc_pcapmi_resfile="$curdir/$resdir_locpcapmi/Dream50_Yeast.res"
