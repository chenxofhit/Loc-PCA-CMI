...
clusterfile="$curdir/$resdir/Dream50_Ecoli_cluster.mat"

#output
zeropc_adjmatrix="$curdir/$resdir/Dream50_Ecoli_adjmatrixg.mat"
...
#res 
zeropc_resfile="$curdir/$resdir/Dream50_Ecoli.res"
